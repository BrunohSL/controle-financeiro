<div x-show="openEdit" class="fixed inset-0 flex items-center justify-center bg-black/60 z-50">
    <div class="bg-white dark:bg-neutral-800 p-6 rounded-lg shadow-lg w-full max-w-md">
        <h2 class="text-xl font-bold mb-4">Editar Conta Bancária <span x-text="name"></span></h2>
        <form wire:submit.prevent="save" class="space-y-4">
            @csrf
            <div class="mb-4">
                <label for="name" class="block mb-1 font-medium">Nome da Conta</label>
                <input type="text" id="name" wire:model="name" x-model="name" maxlength="50" class="w-full border rounded px-3 py-2" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="accountNumber" wire:model="accountNumber" x-model="accountNumber" maxlength="20" class="w-full border rounded px-3 py-2" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="branchNumber" wire:model="branchNumber" x-model="branchNumber" maxlength="10" class="w-full border rounded px-3 py-2" required>
